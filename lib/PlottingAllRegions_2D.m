...
h_leg_1 = legendflex(...
    ...
    {'1 m contours ', ...
    ['Used in the DSA (1953' char(8211) '2017)'],...
    ['Used in the LAPA (1998' char(8211) '2008)'],...
    'Unused',...
    ['Used in the LAPA (2010' char(8211) '2017)'],...
    ['Used in the HAPA (2010' char(8211) '2017)']},...
    'title','Estimated FAC_{10}',...
    'box','off');
h_leg_2 = legendflex([h_obs_1 h_obs_2(1) h_obs_3, h_obs_33 h_obs_2(2)  h_obs_4],...
    {['From the DSA (1953' char(8211) '2017)'],...
    ['From the LAPA (1998' char(8211) '2008)'],...
    ['From the HAPA (2010' char(8211) '2017)'],...
    'From the HAPA (1998)',...
    ['From the LAPA (2010' char(8211) '2017)'],...
